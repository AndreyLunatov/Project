...
export const InputField = ({fieldName, fieldType, label, placeholder, value, onChange}: IInputField) => {
  return (
    <div className={'space-y-2'}>
      ...
      <input type={fieldType}
             ...
             id={fieldName} placeholder={placeholder} value={value} onChange={onChange}
      />
    </div>
  );
}
